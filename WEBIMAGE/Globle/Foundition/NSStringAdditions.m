...
+ (NSString *)nonEmptyString:(id)obj {
    return MBNonEmptyString(obj);
}

- (BOOL)isContentString:(NSString *)string {
    return [MBNonEmptyString(self) rangeOfString:MBNonEmptyString(string)].location != NSNotFound;
}

- (BOOL)hasPrefixWithString:(NSString *)string {
    return ([MBNonEmptyString(self) hasPrefix:MBNonEmptyString(string)] && MBIsStringWithAnyText(string));
}

- (BOOL)hasSuffixWithString:(NSString *)string {
    return ([MBNonEmptyString(self) hasSuffix:MBNonEmptyString(string)] && MBIsStringWithAnyText(string));
}
